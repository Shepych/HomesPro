        ...
        <div class="container">
            <div class="crumbs">
                <ul>
                    ...
                    <li class="active"><a href="#">админпанель ru</a></li>
                </ul>
            </div>
    ...
    <section class="section setup">
        <div class="container">
            <div class="sidebar"><a class="sidebar__item sidebar__item_user" href="{{route('user.cabinet_profile')}}">
                    ...
                    </div>Профиль</a><a class="sidebar__item sidebar__item_accounts">
                ...
                <a class="sidebar__item sidebar__item_admin active">
                    <div class="icon">
            ...
            <div class="setup__content">
                <div class="setup__section">
                    <div class="section__top">
                        ...
                        <button class="add_btn btn" type="button">
                            <svg class="admin-panel_svg" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="admin-panel">
                        <div class="admin-panel__item">
                            <div class="admin-panel__parameters">
                                <select class="admin-panel__select">
                                    <option value="Email">Email</option>
                                    <option selected value="Телефон">Телефон</option>
                                    <option value="Соц.сеть">Соц.сеть</option>
                                </select>
                                <label class="admin-panel__label admin-panel__label-contact">
                                    <input class="phone_mask" type="tel" value="+7 (999) 999 99-99">
                                </label>
                                <label class="admin-panel__label admin-panel__label-city">
                                    <input type="text" placeholder="Город">
                                </label>
                                <label class="admin-panel__label admin-panel__label-file">
                                    <input type="file" name="contact-icon">
                                </label>
                            </div>
                        ...
                        <div class="admin-panel__item">
                            <div class="admin-panel__parameters">
                                <select class="admin-panel__select">
                                    ...
                                    <option selected value="Телефон">
                                        Телефон
                                    </option>
                                    <option value="Соц.сеть">
                                        Соц.сеть
                                    </option>
                                </select>
                                <label class="admin-panel__label admin-panel__label-contact">
                        ...
                        <div class="admin-panel__item">
                            <div class="admin-panel__parameters">
                                ...
                                <label class="admin-panel__label admin-panel__label-contact">
                                    <input type="email" value="emailemail@google.com">
                                </label>
                                <label class="admin-panel__label admin-panel__label-city">
                                    <input type="text" placeholder="Город">
                                </label>
                        ...
                        <div class="admin-panel__item">
                            <div class="admin-panel__parameters">
                                <select class="admin-panel__select">
                                    ...
                                    <option selected value="Соц.сеть">
                                        Соц.сеть
                                    </option>
                                </select>
                                <label class="admin-panel__label admin-panel__label-contact">
                ...
                <div class="setup__section">
                    <div class="section__top">
                        <div style="color: #3ec914" class="section__title">
                            Главная страница
                        </div>
                    </div>
                    <div class="admin-panel__list">
                            ...
                            <div class="admin-panel__item">
                                <div class="admin-panel__parameters">
                                    ...
                                    <label class="admin-panel__label">
                                        <input type="text" value="топ5 2021 года">
                                    </label>
                                </div>
                                <div class="admin-panel__access">
                                    <button class="admin-panel__edit_btn edit_btn" type="button">
                        ...
                        <div class="admin-panel__add_more">
                            <button onclick="clickAddSlide('{{ route('admin.main_page_slider_ru.add_slider') }}')" class="add_btn btn add_btn-right" type="button">
                                <svg class="admin-panel_svg" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M9.91992.730131c.12738-.000161.25368.024818.37138.073506.1178.048689.2248.120131.3149.210233.0901.0901.1615.1971.2102.31485.0487.11776.0737.24396.0735.37138l-.0014 7.25152 7.2515-.00137c.1274 0 .2535.02509.3712.07383.1177.04875.2246.12019.3147.21027.0901.09007.1615.19699.2103.31468.0487.11768.0738.24381.0738.37119 0 .12738-.0251.25348-.0738.37118-.0488.1177-.1202.2246-.2103.3147-.0901.0901-.197.1615-.3147.2103-.1177.0487-.2438.0738-.3712.0738l-7.2515-.0014.0014 7.2515c0 .1274-.0251.2535-.0738.3712-.0488.1177-.1202.2246-.2103.3147-.0901.0901-.197.1615-.3147.2103-.1177.0487-.2438.0738-.37118.0738-.12738 0-.25351-.0251-.37119-.0738-.11768-.0488-.22461-.1202-.31468-.2103-.09007-.0901-.16152-.197-.21027-.3147-.04874-.1177-.07383-.2438-.07383-.3712l.00137-7.2515-7.25151.0014c-.12738 0-.25351-.0251-.3712-.0738-.11768-.0488-.22461-.1202-.31468-.2103-.090069-.0901-.161517-.197-.210263-.3147-.048746-.1177-.073834-.2438-.073835-.37118 0-.12738.025089-.25351.073835-.37119.048745-.11769.120194-.22461.210263-.31468.09007-.09008.197-.16152.31468-.21027.11769-.04874.24382-.07383.3712-.07383l7.25151.00137-.00137-7.25152c-.00016-.12742.02482-.25362.0735-.37138.04869-.11775.12014-.22475.21024-.31485a.968684.968684 0 0 1 .31485-.210233c.11775-.048688.24396-.073667.37138-.073506Z"
                                          fill="#E45847" />
                                </svg>
                        ...
                        @php $i = $main_page_slider_ru->count(); @endphp
                        <div id="main_page_slider_ru">
                        @foreach($main_page_slider_ru as $slide)
                            <div id="main_page_slider_ru_slide_{{ $slide->id }}"  class="admin-panel__content">
                                <div class="admin-panel__item_title">
                                    Слайд № {{ $i-- }}
                                    <button onclick="clickDeleteSlide('{{ route('admin.main_page_slider_ru.delete_slider', $slide->id) }}', {{ $slide->id }})" class="admin-panel__delete_btn delete_btn" type="button">
                                        Удалить
                                    </button>
                                </div>

                                <div class="admin-panel__item">
                                    <form style="width:100%;display:flex" class="main_page_slider_ru_slide_update" action="{{ route('admin.main_page_slider_ru.update_slider', $slide->id) }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="admin-panel__parameters">
                                            <div class="admin-panel__content_name">
                                                Главная фотография
                                ...
                                <div class="admin-panel__item">
                                    <form style="width:100%;display:flex" class="main_page_slider_ru_slide_update" action="{{ route('admin.main_page_slider_ru.update_slider', $slide->id) }}" method="post">
                                        @csrf
                                        <div class="admin-panel__parameters">
                                            <div class="admin-panel__content_name">
                                                Название проекта
                        ...
                        <div class="admin-panel__content">
                            ...
                            <div class="admin-panel__item">
                                <div class="admin-panel__parameters">
                                    ...
                                    <label class="admin-panel__label">
                                                                            <textarea type="text">
                                                                                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Hic, in nulla.
                                                                                    Necessitatibus eius ea cupiditate, similique nostrum possimus unde deleniti.
                                                                                    Laudantium, dolores. Id, facilis iusto! Voluptatum distinctio magni ipsum
                                                                                    ex.
                                                                            </textarea>
                                    </label>
                                </div>
                ...
                <div class="setup__section">
                    <div class="section__top">
                        <div class="section__title">
                            Блок "как мы создаем проект"
                        </div>
                    </div>
                    <div class="admin-panel__add_more">
                        <button class="add_btn btn add_btn-right" type="button">
                            <svg class="admin-panel_svg" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.91992.730131c.12738-.000161.25368.024818.37138.073506.1178.048689.2248.120131.3149.210233.0901.0901.1615.1971.2102.31485.0487.11776.0737.24396.0735.37138l-.0014 7.25152 7.2515-.00137c.1274 0 .2535.02509.3712.07383.1177.04875.2246.12019.3147.21027.0901.09007.1615.19699.2103.31468.0487.11768.0738.24381.0738.37119 0 .12738-.0251.25348-.0738.37118-.0488.1177-.1202.2246-.2103.3147-.0901.0901-.197.1615-.3147.2103-.1177.0487-.2438.0738-.3712.0738l-7.2515-.0014.0014 7.2515c0 .1274-.0251.2535-.0738.3712-.0488.1177-.1202.2246-.2103.3147-.0901.0901-.197.1615-.3147.2103-.1177.0487-.2438.0738-.37118.0738-.12738 0-.25351-.0251-.37119-.0738-.11768-.0488-.22461-.1202-.31468-.2103-.09007-.0901-.16152-.197-.21027-.3147-.04874-.1177-.07383-.2438-.07383-.3712l.00137-7.2515-7.25151.0014c-.12738 0-.25351-.0251-.3712-.0738-.11768-.0488-.22461-.1202-.31468-.2103-.090069-.0901-.161517-.197-.210263-.3147-.048746-.1177-.073834-.2438-.073835-.37118 0-.12738.025089-.25351.073835-.37119.048745-.11769.120194-.22461.210263-.31468.09007-.09008.197-.16152.31468-.21027.11769-.04874.24382-.07383.3712-.07383l7.25151.00137-.00137-7.25152c-.00016-.12742.02482-.25362.0735-.37138.04869-.11775.12014-.22475.21024-.31485a.968684.968684 0 0 1 .31485-.210233c.11775-.048688.24396-.073667.37138-.073506Z"
                                      fill="#E45847" />
                            </svg>
                        ...
                        <div class="admin-panel__content">
                            <div class="admin-panel__item">
                                <div class="admin-panel__parameters">
                                    ...
                                    <label class="admin-panel__label">
                                        <input type="text" value="http://vfsfreferw.com">
                                    </label>
                                </div>
                                <div class="admin-panel__access">
                                    <button class="admin-panel__edit_btn edit_btn" type="button">
                        ...
                        <div class="admin-panel__content">
                            <div class="admin-panel__item">
                                <div class="admin-panel__parameters">
                                    ...
                                    <label class="admin-panel__label">
                                        <input type="text" value="Эскизный проект">
                                    </label>
                                </div>
                                <div class="admin-panel__access">
                                    <button class="admin-panel__edit_btn edit_btn" type="button">
                            ...
                            <div class="admin-panel__item">
                                <div class="admin-panel__parameters">
                                    ...
                                    <div class="admin-panel__label">
                                        <a href="#" download="">ссылка на скачивание</a>
                                    </div>
                                </div>
                                <div class="admin-panel__access">
                                    <button class="admin-panel__edit_btn edit_btn" type="button">
                        ...
                        <div class="admin-panel__content">
                            ...
                            <div class="admin-panel__item">
                                <div class="admin-panel__parameters">
                                    ...
                                    <select class="admin-panel__select">
                                        <option selected value="Вальма">
                                            Вальма
                                        </option>
                                        <option value="Барнхаус">
                                            Барнхаус
                                        </option>
                                        <option value="Флэтхаус">
                                            Флэтхаус
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="admin-panel__item">
                                <div class="admin-panel__parameters">
                                    ...
                                    <label class="admin-panel__label">
                                        <input type="text" value="valma-002-ba">
                                    </label>
                                </div>
                                <div class="admin-panel__access">
                                    <button class="admin-panel__edit_btn edit_btn" type="button">
                            ...
                            <div class="admin-panel__item">
                                <div class="admin-panel__parameters">
                                    ...
                                    <label class="admin-panel__label">
                                        <input type="text" value="40 000 рублей">
                                    </label>
                                </div>
                                <div class="admin-panel__access">
                                    <button class="admin-panel__edit_btn edit_btn" type="button">
                            ...
                            <div class="admin-panel__item">
                                <div class="admin-panel__parameters">
                                    ...
                                    <label class="admin-panel__label">
                                        <input type="text" value="Андрей Бутко">
                                    </label>
                                </div>
                                <div class="admin-panel__access">
                                    <button class="admin-panel__edit_btn edit_btn" type="button">
                        ...
                        <div class="admin-panel__content">
                            ...
                            <div class="admin-panel__item">
                                <div class="admin-panel__parameters">
                                    ...
                                    <label class="admin-panel__label">
                                        <input type="text" value="Андрей Будко, ведущий архитектор">
                                    </label>
                                </div>
                                <div class="admin-panel__access">
                                    <button class="admin-panel__edit_btn edit_btn" type="button">
                            ...
                            <div class="admin-panel__item">
                                <div class="admin-panel__parameters">
                                    ...
                                    <label class="admin-panel__label">
                                        <input type="text" value="Для этого проекта предусмотренно">
                                    </label>
                                </div>
                                <div class="admin-panel__access">
                                    <button class="admin-panel__edit_btn edit_btn" type="button">
                            ...
                            <div class="admin-panel__item">
                                <div class="admin-panel__parameters">
                                    ...
                                    <label class="admin-panel__label">
                                        <input type="text" value="Валерия Барг">
                                    </label>
                                </div>
                                <div class="admin-panel__access">
                                    <button class="admin-panel__edit_btn edit_btn" type="button">
                        ...
                        <div class="admin-panel__content">
                            ...
                            <div class="admin-panel__item">
                                <div class="admin-panel__parameters">
                                    ...
                                    <label class="admin-panel__label">
                                        <input type="text" value="Минимализм">
                                    </label>
                                </div>
                                <div class="admin-panel__access">
                                    <button class="admin-panel__edit_btn edit_btn" type="button">
                            ...
                            <div class="admin-panel__item">
                                <div class="admin-panel__parameters">
                                    ...
                                    <label class="admin-panel__label">
                                        <input type="text" value="3 санузла">
                                    </label>
                                </div>
                                <div class="admin-panel__access">
                                    <button class="admin-panel__edit_btn edit_btn" type="button">
                        ...
                        <div class="admin-panel__content">
                            ...
                            <div class="admin-panel__item">
                                <div class="admin-panel__parameters">
                                    ...
                                    <label class="admin-panel__label">
                                        <input type="text" value="Этажность">
                                    </label>
                                </div>
                                <div class="admin-panel__access">
                                    <button class="admin-panel__edit_btn edit_btn" type="button">
                            ...
                            <div class="admin-panel__item">
                                <div class="admin-panel__parameters">
                                    ...
                                    <label class="admin-panel__label">
                                        <input type="text" value="Общая площадь">
                                    </label>
                                </div>
                                <div class="admin-panel__access">
                                    <button class="admin-panel__edit_btn edit_btn" type="button">
                            ...
                            <div class="admin-panel__item">
                                <div class="admin-panel__parameters">
                                    ...
                                    <label class="admin-panel__label">
                                        <input type="text" value="159 кв метров">
                                    </label>
                                </div>
                                <div class="admin-panel__access">
                                    <button class="admin-panel__edit_btn edit_btn" type="button">
                            ...
                            <div class="admin-panel__item">
                                <div class="admin-panel__parameters">
                                    ...
                                    <label class="admin-panel__label">
                                        <input type="text" value="Форма кровли">
                                    </label>
                                </div>
                                <div class="admin-panel__access">
                                    <button class="admin-panel__edit_btn edit_btn" type="button">
                            ...
                            <div class="admin-panel__item">
                                <div class="admin-panel__parameters">
                                    ...
                                    <label class="admin-panel__label">
                                        <input type="text" value="Вальмовая">
                                    </label>
                                </div>
                                <div class="admin-panel__access">
                                    <button class="admin-panel__edit_btn edit_btn" type="button">
                            ...
                            <div class="admin-panel__item">
                                <div class="admin-panel__parameters">
                                    ...
                                    <label class="admin-panel__label">
                                        <input type="text" value="Тип пола">
                                    </label>
                                </div>
                                <div class="admin-panel__access">
                                    <button class="admin-panel__edit_btn edit_btn" type="button">
                        ...
                        <div class="admin-panel__content">
                            ...
                            <div class="admin-panel__item">
                                <div class="admin-panel__parameters">
                                    ...
                                    <label class="admin-panel__label">
                                        <input type="text" value="http://homespro.com">
                                    </label>
                                </div>
                                <div class="admin-panel__access">
                                    <button class="admin-panel__edit_btn edit_btn" type="button">
                        ...
                        <div class="admin-panel__content">
                            ...
                            <div class="admin-panel__item">
                                <div class="admin-panel__parameters">
                                    ...
                                    <select class="admin-panel__select">
                                        <option selected value="Ландшафтный дизайн">
                                            Ландшафтный дизайн
                                        </option>
                                        <option value="Дизайн интерьера">
                                            Дизайн интерьера
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="admin-panel__item">
                                <div class="admin-panel__parameters">
                                    ...
                                    <label class="admin-panel__label">
                                        <input type="text" value="Андрей Будко">
                                    </label>
                                </div>
                                <div class="admin-panel__access">
                                    <button class="admin-panel__edit_btn edit_btn" type="button">
                        ...
                        <div class="admin-panel__content">
                            ...
                            <div class="admin-panel__item">
                                <div class="admin-panel__parameters">
                                    ...
                                    <label class="admin-panel__label">
                                        <input type="text" value="Архитектор">
                                    </label>
                                </div>
                                <div class="admin-panel__access">
                                    <button class="admin-panel__edit_btn edit_btn" type="button">
                        ...
                        <div class="admin-panel__content">
                            ...
                            <div class="admin-panel__item">
                                <div class="admin-panel__parameters">
                                    ...
                                    <label class="admin-panel__label">
                                        <input type="date" name="review-date">
                                    </label>
                                </div>
                                <div class="admin-panel__access">
                                    <button class="admin-panel__edit_btn edit_btn" type="button">
                        ...
                        <div class="admin-panel__content">
                            ...
                            <div class="admin-panel__item">
                                <div class="admin-panel__parameters">
                                    ...
                                    <label class="admin-panel__label">
                                        <input type="text" value="В.В.Злобин">
                                    </label>
                                </div>
                                <div class="admin-panel__access">
                                    <button class="admin-panel__edit_btn edit_btn" type="button">
